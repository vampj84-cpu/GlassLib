--[[
    GlassLib v2.0.0 (Compiled)
    Liquid Glass UI Library for Roblox Exploits

    Generated by build.lua — do not edit manually
--]]
...
local function require(moduleName)
    if _LOADED[moduleName] then
        return _LOADED[moduleName]
    end
    local mod = _MODULES[moduleName]
    if not mod then
        error("GlassLib: module not found: " .. moduleName, 2)
    end
...
-- Module: src/elements/textinput.lua
_MODULES["textinput"] = function()
--[[
...
-- Module: src/elements/divider.lua
_MODULES["divider"] = function()
--[[
